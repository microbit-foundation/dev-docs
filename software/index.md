...
![Software flow](./assets/software-program.svg)
...
This process further explained in the [MakeCode software page](./makecode) page.
...
The details of this are documented in the [MicroPython](./micropython) page.
...
The micro:bit code is updated by dragging a .hex file onto the MICROBIT drive that appears on your computer, when you plug in the micro:bit. It looks just like a USB memory stick to your computer (the flash drive is actually emulated by the [DAPLink](/firmware/daplink-interface/) software)
