...
slug: /software/python-editor/
---

## Overview

The [Python Editor](https://python.microbit.org) is a free, open source, browser-based coding environment for creating [MicroPython](/software/micropython/) projects with the BBC micro:bit.
