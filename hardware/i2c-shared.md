...
The motion sensors on the board are on the same I2C bus as the edge connector I2C pins. This means that if you have an accessory that uses I2C on this bus, you need to check it won’t clash with any of the possible on-board sensors. The [latest board revision does not share the I2C bus]({{ "/hardware/i2c/" | relative_url }}).
...
![I2C block]({{ "/docs/hardware/assets/nrf51i2c.png" | relative_url }})
