...
slug: /latest-revision/announcement/
sidebar_label: Introducing the latest BBC micro:bit
---
...
![micro\:bit V2 image](./assets/latest-revision/microbit-v2-tech-site.png)
...
![A wall of micro:bit accessories](./assets/latest-revision/accessory-wall-bett.jpg)

<figcaption>The wall of accessories displayed at BETT</figcaption>
</figure>
...
![micro\:bit Software Architecture with CODAL](./assets/latest-revision/software-overview-v2.svg)
...
![Creation of a Universal Hex](./assets/latest-revision/nrf52833.jpg)
...
![micro\:bit guitar](./assets/latest-revision/microbit-guitar.jpg)
...
![Tensorflow Logo](./assets/latest-revision/tensorflow-logo.png)
...
![Edge Impulse visualisation](./assets/latest-revision/edge-impulse.png)
